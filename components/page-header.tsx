  ...
  return (
    <header className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
      <div className="min-w-0">
        <p className="eyebrow mb-2">Terca, 14 de julho</p>
      ...
      <div className="flex items-center gap-2">
        {action}
        <div className="hidden h-11 items-center gap-2 rounded-[7px] border border-[rgba(250,204,21,0.25)] bg-[rgba(250,204,21,0.08)] px-3 text-sm font-black text-[var(--gold)] sm:flex" title="Sequencia atual">
