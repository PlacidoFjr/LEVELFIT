...
import { CreateFoodLogDto, SearchFoodsDto, UpdateNutritionGoalDto } from "./nutrition.dto";
...
export class NutritionController {
  ...
  @Get("foods") foods(@Query() query: SearchFoodsDto) { return this.nutrition.searchFoods(query); }
