...
export const runStats = [
  ...
  { label: "Sessoes hoje", value: "6", detail: "3 corrida, 2 forca, 1 mobilidade", icon: CalendarClock, tone: "cyan" },
...
export const runAthletes: RunAthlete[] = [
  ...
  },
  {
    ...
    name: "Rafael Costa",
    initials: "RC",
    objective: "TAF PM - corrida + flexao",
    status: "attention",
    phase: "Base aerobica",
    readiness: 54,
    weeklyLoad: "9 km",
    nextSession: "Rodagem leve - amanha",
    bestTwoKm: "14:32",
    lastCheckin: "2 dias atras",
  ...
  },
  {
    ...
    readiness: 22,
    weeklyLoad: "0 km",
    nextSession: "Avaliacao inicial - sexta",
    bestTwoKm: "-",
...
export const runSessions: RunSession[] = [
  {
    ...
    type: "base",
    duration: "35 min",
    target: "Conversavel, tecnica solta e sem sprint",
    athletes: 11,
    intensity: "Leve",
  },
  {
  ...
  },
  {
    ...
    type: "recovery",
    duration: "22 min",
    target: "Mobilidade, respiracao e caminhada leve",
    athletes: 9,
...
export const runTimeline = [
  ...
  { time: "18:30", title: "Intervalado TAF", detail: "Sessao principal do dia para 7 atletas.", tone: "cyan" },
] as const;

export const runProgramBlocks = [
  { label: "Seg", title: "Base leve", detail: "30-40 min em zona confortavel", done: true },
  ...
  { label: "Qui", title: "Recuperacao", detail: "Caminhada, mobilidade ou descanso", done: false },
  { label: "Sex", title: "Simulado curto", detail: "Controle de pace sem esgotar", done: false },
] as const;

export const runActivity = [
  { icon: Route, tone: "cyan", title: "7 atletas com treino publicado", detail: "Planos da semana liberados sem GPS obrigatorio." },
